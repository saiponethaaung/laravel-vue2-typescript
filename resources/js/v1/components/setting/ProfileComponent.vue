            ...
            <div>
                <div>
                    <figure class="profileImageCon">
                        <img
                            :src="profile.image ? profile.image : '/images/icons/default-user.jpg'"
                        />
                ...
                <div>
                    <template v-if="edit">
                        ...
                        <template v-else>
                            <div class="profileInputCon">
                                <button class="btnTypeTwo" type="button" @click="resetData()">Cancel</button>
                                <button
                                    class="btnTypeOne"
                                    type="button"
                                    @click="updateProfile()"
                    ...
                    <template v-else>
                        <button class="btnTypeOne" type="button" @click="edit=true">Edit Profile</button>
                    </template>
                </div>
                ...
                <div>
                    ...
                    <template v-else>
                        <template v-if="showQrCode">
                            <div class="profileInputCon">
                                <label>Enter password to see qr code:</label>
...
export default class ProfileComponent extends Vue {
    ...
    @Watch("$store.state.user.facebook_connected", {
        immediate: true,
        deep: true
    })
    ...
    async loadProfile() {
        ...
        await Axios({
            ...
            .catch(err => {
                if (err.response) {
                    alert(
                        err.response.data.mesg || "Failed to load user profile!"
                    );
                }
            });
    ...
    async validatePassword() {
        ...
        await Axios({
            ...
            .catch(err => {
                if (err.response) {
                    alert(
                        err.response.data.mesg || "Failed to validate password!"
                    );
                }
            });
