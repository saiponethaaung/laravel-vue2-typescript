<template>
    <div class="ai-response-text-con">
        <textarea class="ai-response-textarea" @blur="updateContent()" placeholder="Reply text here" v-model="response.content"></textarea>
        <div class="ai-response-text-placeholder" v-html="response.content.replace(/\n/g, '<br />')"></div>
    </div>
</template>
