...
Route::group(['middleware' => ['auth:api', 'verifyUserSession']], function () {

    Route::post('/user/verify-password', 'V1\\Api\\UserAuthController@verifyPassword');
    ...
    Route::group(['prefix' => 'v1'], function () {
        ...
        Route::group(['prefix' => 'project/{projectId}', 'middleware' => ['verifyProject', 'verifyProjectMember']], function () {
            ...
            Route::group(['prefix' => 'attributes'], function () {
                Route::group(['prefix' => 'serach'], function () {
                    Route::post('attribute', 'V1\\Api\\AttributeController@getAttributeSuggestion');
                    Route::post('value', 'V1\\Api\\AttributeController@getAttributeValueSuggestion');
                });
            });
