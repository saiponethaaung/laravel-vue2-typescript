<template>
    <div>
        ...
        <template v-else>
            <template
                v-if="undefined!==content.attachment.payload.buttons && undefined!==content.attachment.payload.buttons.length>0"
            >
                <div class="componentTypeOne">
                    <div class="botTextComponent">
                        ...
                        <div class="textBtn">
                            <div
                                class="addBtn btnCon"
                                v-for="(button, index) in content.attachment.payload.buttons"
                                :key="index"
                            >
